...
from company_blog.main.forms import BlogCategoryForm,UpdateCategoryForm,BlogPostForm,BlogSearchForm,InquiryForm,ClassificationForm
from company_blog import db
from company_blog.main.image_handler import add_featurd_image
...
@main.route('/<int:blog_category_id>/blog_catFgory',methods=['GET','POST'])
...
def create_post():
    ...
    if form.validate_on_submit():
        if form.picture.data:
            pic = add_featurd_image(form.picture.data)
        else:
            pic = ''
...
@main.route('/<int:blog_post_id>/blogpost')
...
def update_post(blog_post_id):
    ...
    if form.validate_on_submit():
        ...
        if form.picture.data:
            blog_post.featured_image = add_featurd_image(form.picture.data)
